...
class FrameList extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Opacity(
      opacity: activeLayer == null || activeLayer == Layers.frame ? 1 : .5,
      child: Container(
        height: 52,
        ...
        child: ListView.builder(
            ...
            itemCount: (totalDuration * .75).toInt(),
            padding: EdgeInsets.symmetric(horizontal: width * .48),
            itemBuilder: (context, index) {
              bool isLast = (totalDuration * .75).toInt() == index + 1;
